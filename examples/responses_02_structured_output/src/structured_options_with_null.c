...
int main(void){
  ...
  openai_v1_responses_set_structured_output(r,"search_opts",SCHEMA,true);
  openai_v1_responses_input_text(r,"Normalize: ‘Find laptops, I don't care about sort order.’");
